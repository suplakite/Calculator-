/****************************************************************************
** Meta object code from reading C++ file 'complex.hpp'
**
...
#error "The header file 'complex.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 9), // "dzialania"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5) // "close"

    },
    "Complex\0dzialania\0\0close"
};
...
QT_INIT_METAOBJECT const QMetaObject Complex::staticMetaObject = {
...
void *Complex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Zespolona"))
        return static_cast< Zespolona*>(this);
